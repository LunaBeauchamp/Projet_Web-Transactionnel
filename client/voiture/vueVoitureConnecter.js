...
let remplirCard = (uneVoiture, index) => {
    ...
    rep +='<div class="product-img">';
                 ...
                 rep += '<a href="#" class="btn btn-primary" data-index="' + index + '">Ajouter au panier  <i class="bi bi-cart-plus-fill" style="color: white;"></i></a>';
                 rep +=' </div>';
                 rep +=' </div>';
