...
let rep =    '<tr>'
rep +='<td class="cellule-td"><img src="'+uneVoiture.image+'"class="imageVoiture"></td>'
rep +='<td class="idVoiture cellule-td">'+uneVoiture.idVoiture+'</td>'
rep +='<td class="nomVoiture cellule-td">'+uneVoiture.nomVoiture+'</td>'
rep +='<td class="descriptionVoiture cellule-td">'+uneVoiture.description+'</td>'
rep +='<td class="prixVoiture cellule-td">'+uneVoiture.prix+'$</td>'
rep +='<td class="quantiteVoiture cellule-td">'+uneVoiture.quantite+'</td>'
rep +='<td ><button class="btn-modifier" onclick="listerOneVoituresAJAX('+uneVoiture.idVoiture+')">Modifier</button></td>'
rep +='<td ><button class="btn-supprimer" onclick="supprimerVoituresAJAX('+uneVoiture.idVoiture+')">Supprimer</button></td>'
rep +='</tr>'        
    return rep;
}
